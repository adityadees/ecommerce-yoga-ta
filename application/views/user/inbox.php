        ...
        <div class="col-sm-9 col-md-9">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="home">
                    <div class="list-group">
                        <?php  foreach ($inbox->result_array() as $ix) :  ?>
                            <a href="<?php echo base_url()?>account/inbox/<?php echo $ix['pesan_id']; ?>" class="list-group-item">
                                <span class="name" style="min-width: 120px; display: inline-block;"><?php echo $ix['cart_kode']; ?></span> 
                                <span class="p-l-25"><?php echo substr($ix['pesan_message'],0, 50)." ....."; ?></span>
                                <span  class="badge"><?php echo date('d-m-Y H:i:s',strtotime($ix['pesan_tanggal'])); ?></span>
